    ...
    <Router>
      <div className={classes.root}>
        ...
        >
          ...
          <Divider />
          <List>
            {[{text: "HOME", path: "/"}, {text: "BOARDS", path: "/boards"}].map(({text, path}, index) => (
              <Link key={text} to={path} className={classes.link}>
                <ListItem button>
                  <ListItemIcon>{index % 2 === 0 ? <HomeIcon /> : <ViewListIcon />}</ListItemIcon>
